...
/// Minimal socket server matching nestty-linux/src/socket.rs logic
...
/// Minimal dispatch matching nestty-linux/src/socket.rs dispatch()
...
/// Client helper matching nestty-cli/src/client.rs
...
impl TestServer {
    fn new(name: &str) -> Self {
        let socket_path = format!("/tmp/nestty-test-{name}-{}.sock", std::process::id());
