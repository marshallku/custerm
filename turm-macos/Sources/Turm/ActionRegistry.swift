...
/// Mirrors `turm-core::action_registry::ActionRegistry` for macOS. Two seams
/// it owns:
///
...
/// in `turm-core/src/action_registry.rs`): legacy match-arm dispatch in
...
/// turm-internal actions that landed here (`system.*`, `context.*` once
/// it ships).
///
...
final class ActionRegistry {
    ...
    /// `publish_completion` (`turm-core/src/action_registry.rs:281`):
    ...
    /// Mirror of `turm_core::action_registry::COMPLETION_EVENT_SOURCE`.
    ...
    nonisolated static let completionEventSource = "turm.action"
}
