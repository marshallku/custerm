...
/// PR 9 / parity-plan Tier 2.2 — Swift mirror of `turm_core::context::ContextService`.
...
///
/// Wire-shape parity with Linux's `Context` struct (`turm-core/src/context.rs`):
...
///
/// Update rules (mirror of `apply_event` in `turm-core/src/context.rs:71`):
...
/// `turmEngine.dispatchEvent`, taking the post-apply snapshot to pass through
/// FFI. This mirrors Linux's `Pump::pump_all` (`turm-linux/src/window.rs:589`)
