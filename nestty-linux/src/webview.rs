...
fn build_webview_css(theme: &nestty_core::theme::Theme) -> String {
    format!(
        r#"
.nestty-url-bar {{
...
impl WebViewPanel {
    pub fn new(url: &str, theme: &nestty_core::theme::Theme) -> Self {
        ...
        forward_btn.add_css_class("nestty-nav-btn");
